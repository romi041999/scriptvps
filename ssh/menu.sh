...
echo -e "$y-------------------------------------------------------------$wh"
echo -e "$y             Telegram : https://t.me/romisyafrial $wh"
echo -e "$y           Premium Auto Script By romi syafrial $wh"
echo -e "$y-------------------------------------------------------------$wh"
echo ""
...
echo -e "$yy 3$y.Renew SSH & OpenVPN Account Active Life"
...
echo -e "$yy 30$y.Renew Account SSR Active Life"
...
echo -e "$yy 34$y.Renew Account XRAYS Vmess Active Life"
...
echo -e "$yy 39$y.Renew Account XRAYS Vless Active Life"
...
echo -e "$yy 43$y.Renew Account XRAYS Trojan Active Life"
...
echo -e "$yy 47$y.Renew Account Trojan Go Active Life"
